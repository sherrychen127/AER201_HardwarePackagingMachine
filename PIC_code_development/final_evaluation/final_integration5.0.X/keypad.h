...
int B_input = 0;   //read the digital output from breakbeam sensors  (1: pass through 0: nothing pass through)
int N_input = 0;
int S_input = 0;
int W_input = 0;
...
int spacingTime = 3000;  //nothing dispense during the time, then the DC_motor would stop  
//5000 (8-9 sec)    4000 (6-7 sec)
...
int B_total_dispensed = 0; //change to 1 when remaining Bolt is dispensed
int N_total_dispensed = 0;
int S_total_dispensed = 0;
int W_total_dispensed = 0;





int B_max = 4; //arbitrary max number for nuts (for testing)
int N_max = 4;
int S_max = 4;
int W_max = 4;
...
/*unsigned char B_dispense = '2';   (not needed)
