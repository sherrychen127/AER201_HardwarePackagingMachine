 ...
 * File:   main.c
 * Author: sherrychan
 *   nuts dispense using interrupt: counting mechanism is reliable after testing 
...
void main(void) {
    ...
    I2C_sendData('7'); //start motor
    
    while(1){
        TRISBbits.RB4 = 1; // set data direction for RA0 to input (i.e. 1)
        int input = PORTBbits.RB4;
        initLCD();
        //printf("%d",input);
        printf("%d",N_count);
        /*
